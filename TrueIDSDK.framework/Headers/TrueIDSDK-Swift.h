...
SWIFT_CLASS("_TtC9TrueIDSDK11AccessToken")
@interface AccessToken : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (nonnull instancetype)initWithAccess_token:(NSString * _Nonnull)access_token expires_in:(NSInteger)expires_in refresh_token:(NSString * _Nonnull)refresh_token token_type:(NSString * _Nonnull)token_type ekyc_api_url:(NSString * _Nonnull)ekyc_api_url OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, copy) NSString * _Null_unspecified domainPath;
@property (nonatomic, copy) NSString * _Null_unspecified authDomain;
@property (nonatomic, copy) NSString * _Null_unspecified authDomainPath;
@property (nonatomic, copy) NSString * _Null_unspecified appId;
@property (nonatomic, copy) NSString * _Null_unspecified appSecret;
...
SWIFT_CLASS("_TtC9TrueIDSDK11DaiNamToken")
@interface DaiNamToken : NSObject
@property (nonatomic, copy) NSString * _Nonnull access_token;
@property (nonatomic, copy) NSString * _Nonnull expires_in;
@property (nonatomic, copy) NSString * _Nonnull refresh_token;
@property (nonatomic, copy) NSString * _Nonnull token_type;
@property (nonatomic, copy) NSString * _Nonnull ekyc_api_url;
- (nonnull instancetype)initWithAccess_token:(NSString * _Nonnull)access_token expires_in:(NSString * _Nonnull)expires_in refresh_token:(NSString * _Nonnull)refresh_token token_type:(NSString * _Nonnull)token_type ekyc_api_url:(NSString * _Nonnull)ekyc_api_url OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC9TrueIDSDK8StepInfo")
...
+ (void)captureFrontWithListener:(void (^ _Nonnull)(CardInfo * _Nonnull))listener;
+ (void)captureBackWithListener:(void (^ _Nonnull)(CardInfo * _Nonnull))listener;
+ (void)captureSelfieWithListener:(void (^ _Nonnull)(CardInfo * _Nonnull))listener;
+ (void)captureSubmitWithListener:(void (^ _Nonnull)(CardInfo * _Nonnull))listener;
